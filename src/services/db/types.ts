...
export interface DbConfig {
  ...
  /** Database host (PostgreSQL/MySQL only) */
  host?: string;
  
  /** Database port (PostgreSQL/MySQL only) */
  port?: number;
  
  /** Database username (PostgreSQL/MySQL only) */
  user?: string;
  
  /** Database password (PostgreSQL/MySQL only) */
  password?: string;
  
  /** Database name (PostgreSQL/MySQL only) */
  database?: string;
}
